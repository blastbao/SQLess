...
import (
	...
	"github.com/SQLess/SQLess/conf/testnet"
...
func init() {
	...
	CmdGenerate.Flag.StringVar(&testnetRegion, "testnet", testnetW,
		"Generate config using the specified testnet region: w. Conflict with -source param")
