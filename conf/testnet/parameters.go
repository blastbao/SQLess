...
const (
	// CQLConfigYAML is the config string in YAML format of the SQLess TestNet.
	CQLConfigYAML = `
SQLChainPeriod: 60s
DNSSeed:
  ...
  BPCount: 6
`
	// CQLMinerYAML is the config string in YAML format of the SQLess TestNet for miner.
	CQLMinerYAML = `
...
// GetTestNetConfig parses and returns the SQLess TestNet config.
